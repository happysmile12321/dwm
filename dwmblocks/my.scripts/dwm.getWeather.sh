...
# getforecast() { 
# curl -sf  wttr.in/`cat ~/.local/share/weatherreport |grep "Weather report"|awk '{print $3}'` > "$weatherreport" || exit 1 ;
# }
getforecast() { curl -sf "wttr.in/Jiaozuo" > "$weatherreport" || exit 1 ;}
